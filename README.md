...
2. Implement the dataset loader:
   ...
   2. Re-Implement the class of `HDF5VLADataset`:
      ...
      You can find this class in [this file](data/hdf5_vla_dataset-1.py). In this file, we provide an example of loading the fine-tuning dataset used in our paper (see [this link](https://huggingface.co/datasets/robotics-diffusion-transformer/rdt-ft-data)).
